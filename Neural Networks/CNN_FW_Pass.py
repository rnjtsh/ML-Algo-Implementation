...
imagePath = '/home/raja/Raja/Sem2/SMAI/Assignment2/dog.jpg'
...
hparameters_forward = {"pad": int(W.shape[0] / 2), "stride": 1}
...
for i in range(2):
    ...
    plt.imshow(A[0])
    plt.title('Output of pooling layer ' + str(i+1))
    plt.savefig('ConvPoolLayer_' + str(i+1) + '.jpg')
    plt.clf()
